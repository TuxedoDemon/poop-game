...
function musicForSomeReason(command, fartingAround){
...
function startPooping(e, callback){
...
function poopAgain(final, poopagain, fartingAround){
...
function handlePoopStart(fartingAround, messageArea, json){
...
function handleMostPoops(json, i, zindex, messageArea, interval, fartingAround, limit){
...
function handleFinalPoop(json, interval, i, fartingAround){
...
function populatePoop(speed, messageArea, fartingAround, json, i, zindex, limit){
    ...
    const interval = setInterval(() => {
        ...
        switch(i){
            case json.length - 1:
                clearInterval(interval);
                handleFinalPoop(json, interval, i, fartingAround);
            break;
            case 0:
